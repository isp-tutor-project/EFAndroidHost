...
import static org.edforge.androidhost.AndroidHost.logManager;
import static org.edforge.androidhost.TCONST.ASSET_UPDATE_VERSION;
...
public class CAssetObject {
    ...
    private boolean safeDeleteFile(File assetFile) {
        ...
        if(assetFile != null) {
            ...
            if(AndroidHost.DELETE_INSTALLED_ASSETS) {
                assetFile.delete();
            }
        }
